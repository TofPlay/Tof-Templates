...
//extension ___FILEBASENAMEASIDENTIFIER___: UITableViewDataSourcePrefetching {
  ...
  //internal func tableView(_ pTableView: UITableView, cancelPrefetchingForRowsAt pIndexPaths: [IndexPath]) {
  //  // Your code here
  //}
//}
...
//extension ___FILEBASENAMEASIDENTIFIER___: UITableViewDragDelegate {
  ...
  //internal func tableView(_ pTableView: UITableView, itemsForBeginning pSession: UIDragSession, at pIndexPath: IndexPath) -> [UIDragItem] {
  //  var lRet:[UIDragItem] = []
  //
  //  // Change lRet here and add your code
  //
  ...
  //internal func tableView(_ pTableView: UITableView, itemsForAddingTo pSession: UIDragSession, at pIndexPath: IndexPath, point pPoint: CGPoint) -> [UIDragItem] {
  //  var lRet:[UIDragItem] = []
  //
  //  // Change lRet here and add your code
  //
  ...
  //internal func tableView(_ pTableView: UITableView, dragSessionWillBegin pSession: UIDragSession) {
  //  // Your code here
  //}
  
  // Signals the end of a drag operation involving content from the specified table view
  //internal func tableView(_ pTableView: UITableView, dragSessionDidEnd pSession: UIDragSession) {
  //  // Your code here
  //}
  ...
  //internal func tableView(_ pTableView: UITableView, dragPreviewParametersForRowAt pIndexPath: IndexPath) -> UIDragPreviewParameters? {
  ...
  //internal func tableView(_ pTableView: UITableView, dragSessionAllowsMoveOperation pSession: UIDragSession) -> Bool {
  //  var lRet:Bool = false
  //
  //  // Change lRet here and add your code
  //
...
//extension ___FILEBASENAMEASIDENTIFIER___: UITableViewDropDelegate {
  ...
  //internal func tableView(_ pTableView: UITableView, performDropWith pCoordinator: UITableViewDropCoordinator) {
  //  // Your code here
  //}
  ...
  //internal func tableView(_ pTableView: UITableView, canHandle pSession: UIDropSession) -> Bool {
  //  var lRet:Bool = false
  //
  //  // Change lRet here and add your code
  //
  ...
  //internal func tableView(_ pTableView: UITableView, dropSessionDidUpdate pSession: UIDropSession, withDestinationIndexPath pDestinationIndexPath: IndexPath?) -> UITableViewDropProposal {
  ...
  //internal func tableView(_ pTableView: UITableView, dropSessionDidEnter pSession: UIDropSession) {
  //  // Your code here
  //}
  
  // Called when dragged content exits the table view's bounds rectangle.
  //internal func tableView(_ pTableView: UITableView, dropSessionDidExit pSession: UIDropSession) {
  //  // Your code here
  //}

  // Called to notify you when the drag operation ends.
  //internal func tableView(_ pTableView: UITableView, dropSessionDidEnd pSession: UIDropSession) {
  //  // Your code here
  //}
//}
