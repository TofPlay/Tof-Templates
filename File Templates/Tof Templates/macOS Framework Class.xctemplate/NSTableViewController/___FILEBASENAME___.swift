...
// MARK: -
open class ___FILEBASENAMEASIDENTIFIER___Cell : NSTableCellView {
  // MARK: -
...
// MARK: -
open class ___FILEBASENAMEASIDENTIFIER___: NSViewController, NSTableViewDataSource, NSTableViewDelegate {
  // MARK: -
  // MARK: Interface
  // MARK: -
  ...
  @IBOutlet weak open var tableView: NSTableView!
  ...
  //open func tableView(_ pTableView: NSTableView, objectValueFor pTableColumn: NSTableColumn?, row pRow: Int) -> Any? {
  //  var lRet:Any? = nil
  //
  ...
  //open func tableView(_ pTableView: NSTableView, setObjectValue pObject: Any?, for pTableColumn: NSTableColumn?, row pRow: Int) {
  //
  //  if self.items.count > 0 && pRow < self.items.count {
  ...
  //open func tableView(_ pTableView: NSTableView, pasteboardWriterForRow pRow: Int) -> NSPasteboardWriting? {
  ...
  //open func tableView(_ pTableView: NSTableView, acceptDrop pInfo: NSDraggingInfo, row pRow: Int, dropOperation pDropOperation: NSTableViewDropOperation) -> Bool {
  //  var lRet: Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, namesOfPromisedFilesDroppedAtDestination pDropDestination: URL, forDraggedRowsWith pIndexSet: IndexSet) -> [String] {
  //  var lRet:[String] = []
  //  
  //  // Your code here
  //
  ...
  //open func tableView(_ pTableView: NSTableView, validateDrop pInfo: NSDraggingInfo, proposedRow pRow: Int, proposedDropOperation pDropOperation: NSTableViewDropOperation) -> NSDragOperation {
  ...
  //open func tableView(_ pTableView: NSTableView, writeRowsWith pRowIndexes: IndexSet, to pPasteboard: NSPasteboard) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Change lRet here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, draggingSession pSession: NSDraggingSession, willBeginAt pScreenPoint: NSPoint, forRowIndexes pRowIndexes: IndexSet) {
  //  // Your code here
  //}

  // Implement this method to allow the table to update dragging items as they are dragged over a view.
  //open func tableView(_ pTableView: NSTableView, updateDraggingItemsForDrag pDraggingInfo: NSDraggingInfo) {
  //  // Your code here
  //}
  
  // Implement this method to allow the table to update dragging items as they are dragged over a view.
  //open func tableView(_ pTableView: NSTableView, draggingSession pSession: NSDraggingSession, endedAt pScreenPoint: NSPoint, operation pOperation: NSDragOperation) {
  //  // Your code here
  //}
  ...
  //open func tableView(_ pTableView: NSTableView, sortDescriptorsDidChange pOldDescriptors: [NSSortDescriptor]) {
  //  // Your code here
  //}
  ...
  //open func tableView(_ pTableView: NSTableView, viewFor pTableColumn: NSTableColumn?, row pRow: Int) -> NSView? {
  //  var lRet:NSView? = nil
  //
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, rowViewForRow pRow: Int) -> NSTableRowView? {
  ...
  //open func tableView(_ pTableView: NSTableView, didAdd pRowView: NSTableRowView, forRow pRow: Int) {
  //  // Your code here
  //}
  
  // Tells the delegate that a row view was removed from the table at the specified row.
  //open func tableView(_ pTableView: NSTableView, didRemove pRowView: NSTableRowView, forRow pRow: Int) {
  //  // Your code here
  //}
  ...
  //open func tableView(_ pTableView: NSTableView, isGroupRow pRow: Int) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, willDisplayCell pCell: Any, for pTableColumn: NSTableColumn?, row pRow: Int) {
  //  // Your code here
  //}
  
  // Asks the delegate for a custom data cell for the specified row and column.
  //open func tableView(_ pTableView: NSTableView, dataCellFor pTableColumn: NSTableColumn?, row pRow: Int) -> NSCell? {
  //  var lRet:NSCell? = nil
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, shouldShowCellExpansionFor pTableColumn: NSTableColumn?, row pRow: Int) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, toolTipFor pCell: NSCell, rect pRect: NSRectPointer, tableColumn pTableColumn: NSTableColumn?, row pRow: Int, mouseLocation pMouseLocation: NSPoint) -> String {
  //  var lRet:String = ""
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, shouldEdit pTableColumn: NSTableColumn?, row pRow: Int) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, heightOfRow pRow: Int) -> CGFloat {
  ...
  //open func tableView(_ pTableView: NSTableView, sizeToFitWidthOfColumn pColumn: Int) -> CGFloat {
  //  var lRet:CGFloat = 0.0
  //  
  //  // Your code here
  //  
  ...
  //open func selectionShouldChange(in pTableView: NSTableView) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, shouldSelectRow pRow: Int) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, selectionIndexesForProposedSelection pProposedSelectionIndexes: IndexSet) -> IndexSet {
  ...
  //open func tableView(_ pTableView: NSTableView, shouldSelect pTableColumn: NSTableColumn?) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableViewSelectionIsChanging(_ pNotification: Notification) {
  //  // Your code here
  //}
  ...
  //open func tableView(_ pTableView: NSTableView, typeSelectStringFor pTableColumn: NSTableColumn?, row pRow: Int) -> String? {
  //  var lRet:String? = nil
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, nextTypeSelectMatchFromRow pStartRow: Int, toRow pEndRow: Int, for pSearchString: String) -> Int {
  //  var lRet:Int = 0
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, shouldReorderColumn pColumnIndex: Int, toColumn pNewColumnIndex: Int) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, didDrag pTableColumn: NSTableColumn) {
  //  // Your code here
  //}
  
  // Tells the delegate that a table column was moved by user action.
  //open func tableViewColumnDidMove(_ pNotification: Notification) {
  //  // Your code here
  //}
  
  // Tells the delegate that a tablecolumn was resized.
  //open func tableViewColumnDidResize(_ pNotification: Notification) {
  //  // Your code here
  //}
  ...
  //open func tableView(_ pTableView: NSTableView, didClick pTableColumn: NSTableColumn) {
  //  // Your code here
  //}
  
  // Tells the delegate that the mouse button was clicked in the specified table column’s header.
  //open func tableView(_ pTableView: NSTableView, mouseDownInHeaderOf pTableColumn: NSTableColumn) {
  //  // Your code here
  //}
  
  // Asks the delegate whether the specified cell should be tracked.
  //open func tableView(_ pTableView: NSTableView, shouldTrackCell pCell: NSCell, for pTableColumn: NSTableColumn?, row pRow: Int) -> Bool {
  //  var lRet:Bool = false
  //  
  //  // Your code here
  //  
  ...
  //open func tableView(_ pTableView: NSTableView, rowActionsForRow pRow: Int, edge pEdge: NSTableRowActionEdge) -> [NSTableViewRowAction] {
