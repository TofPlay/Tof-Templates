...
// MARK: -
open extension ___FILEBASENAMEASIDENTIFIER___: UICollectionViewDataSource {
...
// MARK: -
open extension ___FILEBASENAMEASIDENTIFIER___: UICollectionViewDelegate {
...
// MARK: -
open extension ___FILEBASENAMEASIDENTIFIER___: UICollectionViewDelegateFlowLayout {
...
@available(iOS 10.0, *)
open extension ___FILEBASENAMEASIDENTIFIER___: UICollectionViewDataSourcePrefetching {

  // Instructs your prefetch data source object to begin preparing data for the cells at the supplied index paths.
  //open func collectionView(_ pCollectionView: UICollectionView, prefetchItemsAt pIndexPaths: [IndexPath]) {
  //  // Your code here
  //}

  // Cancels a previously triggered data prefetch request.
  //open func collectionView(_ pCollectionView: UICollectionView, cancelPrefetchingForItemsAt pIndexPaths: [IndexPath]) {
  //  // Your code here
  //}
//}
...
//extension ___FILEBASENAMEASIDENTIFIER___: UICollectionViewDragDelegate {
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, itemsForBeginning pSession: UIDragSession, at pIndexPath: IndexPath) -> [UIDragItem] {
  //  var lRet:[UIDragItem] = []
  //
  //  // Change lRet here and add your code
  //
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, itemsForAddingTo pSession: UIDragSession, at pIndexPath: IndexPath, point pPoint: CGPoint) -> [UIDragItem] {
  //  var lRet:[UIDragItem] = []
  //
  //  // Change lRet here and add your code
  //
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, dragSessionWillBegin pSession: UIDragSession) {
  //  // Your code here
  //}

  // Signals the end of a drag operation involving content from the specified collection view
  //open func collectionView(_ pCollectionView: UICollectionView, dragSessionDidEnd pSession: UIDragSession) {
  //  // Your code here
  //}
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, dragPreviewParametersForItemAt pIndexPath: IndexPath) -> UIDragPreviewParameters? {
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, dragSessionAllowsMoveOperation pSession: UIDragSession) -> Bool {
  //  var lRet:Bool = false
  //
  //  // Change lRet here and add your code
  //
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, dragSessionIsRestrictedToDraggingApplication pSession: UIDragSession) -> Bool {
  //  var lRet:Bool = false
  //
  //  // Change lRet here and add your code
  //
...
@available(iOS 11.0, *)
open extension ___FILEBASENAMEASIDENTIFIER___: UICollectionViewDropDelegate {

  //MARK: -> Incorporating the Dropped Data
  
  // Incorporates the dropped data into your data structures and updates the table.
  //open func collectionView(_ pCollectionView: UICollectionView, performDropWith pCoordinator: UICollectionViewDropCoordinator) {
  //  // Your code here
  //}
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, canHandle pSession: UIDropSession) -> Bool {
  //  var lRet:Bool = false
  //
  //  // Change lRet here and add your code
  //
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, dropSessionDidUpdate pSession: UIDropSession, withDestinationIndexPath pDestinationIndexPath: IndexPath?) -> UICollectionViewDropProposal {
  ...
  //open func collectionView(_ pCollectionView: UICollectionView, dropSessionDidEnter pSession: UIDropSession) {
  //  // Your code here
  //}

  // Called when dragged content exits the collection view's bounds rectangle.
  //open func collectionView(_ pCollectionView: UICollectionView, dropSessionDidExit pSession: UIDropSession) {
  //  // Your code here
  //}

  // Called to notify you when the drag operation ends.
  //open func collectionView(_ pCollectionView: UICollectionView, dropSessionDidEnd pSession: UIDropSession) {
  //  // Your code here
  //}
}
